/*
const ProvenanceStorageMock = artifacts.require('./ProvenanceStorage');
...
contract('ProvenanceStorage', async (accounts) => {
  ...
  it("should allow adding, deleting, and adding again a provenance record with the same ID", async () => {
      // create
      let expected = {
          0: {dataId: 0,  context: "contextA", index: 0},
          1: {dataId: 1,  context: "contextB", index: 1}
      };
      ...
      expected = {
          0: {dataId: 0,  context: "contextA", index: 0},
          1: {dataId: 1,  context: "contextBModified", index: 1}
      };
      await createProvenanceRecord(storage, 1, expected[1]);
      await checkCorrectProvenanceRecords(storage, expected);
  });
  ...
  it("should update indices correctly when provenance records are deleted", async () => {
      ...
      let expected = {
          0: {dataId: 0,  context: "contextA", index: 0},
          1: {dataId: 1,  context: "contextB", index: 1},
          2: {dataId: 1,  context: "contextC", index: 2},
          3: {dataId: 1,  context: "contextD", index: 3}
      };
      ...
      expected = {
          1: {dataId: 1,  context: "contextB", index: 1},
          2: {dataId: 1,  context: "contextC", index: 2},
          3: {dataId: 1,  context: "contextD", index: 0}
      };
      ...
      expected = {
          2: {dataId: 1,  context: "contextC", index: 1},
          3: {dataId: 1,  context: "contextD", index: 0}
      };
      await storage.deleteProvenance(1);
      await checkCorrectProvenanceRecords(storage, expected);
      ...
      expected = {
          2: {dataId: 1,  context: "contextC", index: 0},
      };
