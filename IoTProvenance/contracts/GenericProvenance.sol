...
contract GenericProvenance is Provenance, ERC721, ERC721Metadata, ERC721Enumerable, ProvenanceStorage{
     ...
     */
    function _createProvenance(uint _tokenId, string memory _context) internal returns (uint index)
    {
        ...
        return super._createProvenance(provId, _tokenId, _context);
    }
    ...
    function _updateProvenance(uint _provId,uint _tokenId,string memory _context) internal returns (bool success)
    {
        ...
        return super._updateProvenance(_provId, _tokenId, _context);
    }
